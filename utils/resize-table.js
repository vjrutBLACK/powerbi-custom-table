...
//  table.style.overflow = 'hidden';
 ...
 function setListeners(div){
  var pageX,curCol,nxtCol,curColWidth,nxtColWidth, currentTableWidth, windowWidth, oldDiff;
  ...
  document.addEventListener('mousemove', function (e) {
   ...
   if (curCol) {
    ...
    let remainingTableWidth = parseInt(currentTableWidth) - parseInt(curColWidth)
